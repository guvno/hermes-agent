...
DEFAULT_CONFIG = {
    ...
    "tts": {
        "provider": "edge",  # "edge" (free) | "elevenlabs" (premium) | "openai" | "xai" | "minimax" | "mistral" | "gemini" | "google_cloud" | "neutts" (local) | "kittentts" (local) | "piper" (local/HTTP) | "melotts"
        "edge": {
        ...
        "piper": {
            # Native local Piper voice name (e.g. "en_US-lessac-medium") downloaded on first use,
            # OR an absolute path to a pre-downloaded .onnx file.
            ...
            # Optional compatibility mode for an external Piper HTTP server:
